...
public class MainWindow extends JFrame {
	...
	private void initGUI() {
		...
		JPanel juctionsView = createViewPanel(new JTable(new JunctionsTableModel(_ctrl)), "Junctions");
		juctionsView.setPreferredSize(new Dimension(500, 200));
		tablesPanel.add(juctionsView);
